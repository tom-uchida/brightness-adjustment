...
fig.subplots_adjust(hspace=0.3, wspace=0.6) # interval
...
#img_in_RGB = read_img("images/2018-10-21/ChestX-ray14.png")
...
#show_img(0, img_in_gray,   "Original image")
show_img(1, img_out_RGB,  "Improved image")
#show_img(1, img_out_gray,  "Improved image")
...
# get_data_of_pixel_value(img_in_R_nonzero)
# get_data_of_pixel_value(img_in_G_nonzero)
# get_data_of_pixel_value(img_in_B_nonzero)
# get_data_of_pixel_value(img_out_R_nonzero)
# get_data_of_pixel_value(img_out_G_nonzero)
# get_data_of_pixel_value(img_out_B_nonzero)
...
# cv2.imwrite("images/output_before.jpg", img_in_gray)
# cv2.imwrite("images/output_after.jpg",  img_out_gray)
...
# ----------------------
# original image
#ax[2].hist(img_in_gray_nonzero.ravel(), bins=50, color='black')
#ax[2].hist(img_in_RGB_nonzero.ravel(), bins=50, color='black')
...
# improved image
#ax[3].hist(img_out_gray_nonzero.ravel(), bins=50, color='black')

...
if len(args) != 3:
    print("\n")
    print("USAGE   : $ python adjust_brightness_decompose.py [input_image_data] [input_image_data(LR=1)]")
    print("EXAMPLE : $ python adjust_brightness_decompose.py [input_image.bmp] [input_image_LR1.bmp]")
    #raise Exception
    sys.exit()

##################################################
#   @file   adjust_brightness_special_case.py
...
# Message
print("===============================================")
print("     Brightness Adjustment (Special case)")
...
if len(args) != 3:
    print("\n")
    print("USAGE   : $ python adjust_brightness_special_case.py [input_image_data] [input_image_data(LR=1)]")
    print("EXAMPLE : $ python adjust_brightness_special_case.py [input_image.bmp] [input_image_LR1.bmp]")
    #raise Exception
    sys.exit()
...
if __name__ == "__main__":
    ...
    print(" Testing...")  
    print("====================================")
    searchThresholdPixelValue(img_in_RGB)
